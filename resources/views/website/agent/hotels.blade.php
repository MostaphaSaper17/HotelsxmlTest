...
@section('content')
    ...
    <div id="st-content-wrapper" class="search-result-page">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="form-group form-date-field form-date-search clearfix  has-icon " data-format="DD/MM/YYYY">
                                ...
                                <div class="date-wrapper clearfix">
                                    <div class="check-in-wrapper">
                                        <label>Guests</label>
                                        <div class="inputg check-in-render"> 2 Adults - 0 Child -  1 Roomffff</div>
                                    </div>
                                </div>
        ...
        <div class="container">
            ...
            <div class="clearfix"></div>
            <!-- Modal -->
            <div id="openFilter" class="modal fade" role="dialog">
            ...
            <div class="st-hotel-result">
                <div class="row">
                    ...
                    <div class="sidebar-item map-view-wrapper hidden-xs hidden-sm mt20">
                        <div class="map-view">
                            <a href="!#" class="btn btn-secondary"><i class="fas fa-map-marker-alt " aria-hidden="true"></i>MAPS VIEW  </a>
                        </div>
                    </div>
                            ...
                            <div class="item-service rectangle-hotel-list-area">
                                <div class="row item-service-wrapper matchHeight">
                                    ...
                                    <div class="col-sm-3 section-footer">
                                        ...
                                        <div class="select-room-area"><a class="btn-show-price btn btn-primary upper mt5" href="{{ route('agent.hotel-details') }}" role="button" aria-expanded="false" aria-controls="select-room-table-1">Show More Rooms</a></div>
                                    </div>
                                </div>
